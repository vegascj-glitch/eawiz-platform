...
import { InboxIntelligence } from '@/components/tools/inbox-intelligence/InboxIntelligence';
import { Button } from '@/components/ui/Button';
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '@/components/ui/Card';

export const metadata = {
  title: 'Inbox Intelligence - EAwiz',
  description: 'Triage inbox content by organizing messages into priorities, actions, and follow-ups.',
};
      ...
      <>
        <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white">
          <div className="container py-12">
            ...
            <h1 className="text-4xl font-bold">Inbox Intelligence</h1>
            <p className="mt-4 text-lg text-primary-100 max-w-2xl">
              Triage inbox content by organizing messages into priorities, actions, and follow-ups.
            </p>
          </div>
        </section>
            ...
            <Card variant="bordered" className="text-center">
              <CardHeader>
                ...
                <CardDescription className="text-base mt-2">
                  Inbox Intelligence is available exclusively to EAwiz members.
    ...
    <>
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white">
        <div className="container py-8">
          ...
          <h1 className="text-3xl font-bold">Inbox Intelligence</h1>
