...
import { AccomplishmentsTracker } from '@/components/tools/accomplishments-tracker/AccomplishmentsTracker';
import { Button } from '@/components/ui/Button';
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '@/components/ui/Card';

export const metadata = {
  title: 'Accomplishments Tracker - EAwiz',
  description: 'Log EA impact and generate review-ready bullets and summaries.',
};

export default async function AccomplishmentsTrackerPage() {
      ...
      <>
        <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white">
          <div className="container py-12">
            ...
            <h1 className="text-4xl font-bold">Accomplishments Tracker</h1>
            <p className="mt-4 text-lg text-primary-100 max-w-2xl">
              Log EA impact and generate review-ready bullets and summaries.
            </p>
          </div>
        </section>
            ...
            <Card variant="bordered" className="text-center">
              <CardHeader>
                ...
                <CardDescription className="text-base mt-2">
                  The Accomplishments Tracker is available exclusively to EAwiz members.
    ...
    <>
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white">
        <div className="container py-8">
          ...
          <h1 className="text-3xl font-bold">Accomplishments Tracker</h1>
