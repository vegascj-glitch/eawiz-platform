...
export const metadata = {
  ...
  description: 'One hour of personalized coaching with Courtney for Executive Assistants. Get unstuck, build custom GPTs, app training, resume revamp, and more.',
};
        ...
        <div className="container py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl text-primary-100">
              One hour with Courtney. Deep dive. Leave with a plan and momentum.
            </p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">60 minutes of focused, 1:1 coaching with Courtney</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900">Book Your Session</h3>
                <p className="mt-2 text-gray-600">
                  Fill out the form below and complete payment.
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center text-xl font-bold mx-auto">
          ...
          <div className="max-w-2xl mx-auto">
            <Card variant="bordered">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl">Book Your Session with Courtney</CardTitle>
                <CardDescription>
